...
public class NetManagement {
	...
	private BankAccountMethod bankAccountMethod ;
	private MomoMethod momoMethod ;
	...
	public NetManagement() {
		...
		bankAccountMethod = new BankAccountMethod("Nguyen Van A", "0332323123112");
		momoMethod = new MomoMethod("Nguyen Van A","0369092823");
	...
	public double getDiscount() {
		return paymentMethod.payment(getAmount());
	}
...
//		-------------------------------------------------------------------------------------
	...
	public String getMomodescription(){
		return momoMethod.description();
	}
	public String getBAdescription(){
		return bankAccountMethod.description();
	}
	...
	public BankAccountMethod getBankAccountMethod() {
		return bankAccountMethod;
	}
	public MomoMethod getMomoMethod() {
		return momoMethod;
	}
