...
public class ExcelController implements WindowListener {
	...
	public void windowClosing(WindowEvent e) {
		try {
			...
			JTable oldOrderData = getOldData("C:\\Users\\ADMIN\\Desktop\\TransactionHistory.xlsx", columnsOrderName);
			
			exportHistoryToExcel(LinkData(oldOrderData, frame.history.getHistoryTable(), columnsOrderName), "C:\\Users\\ADMIN\\Desktop\\TransactionHistory.xlsx");
			exportQuantityToExcel(frame.history.getQuantityTable(), "C:\\Users\\ADMIN\\Desktop\\RemainQuantity.xlsx");
		} catch (Exception e1) {
