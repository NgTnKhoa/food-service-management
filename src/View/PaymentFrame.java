...
public class PaymentFrame extends JFrame {
	...
	public PaymentFrame() {
		...
		contentPane.add(panel_BA);
		 ...
		 ba_RadioBtn.setBounds(0, 0, 179, 39);
		 ba_RadioBtn.setName("Bank Account");
		ba_RadioBtn.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 22));
		...
		momo_RadioBtn.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 22));
		momo_RadioBtn.setBounds(0, 0, 91, 39);
		...
		cash_RadioBtn.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 22));
		cash_RadioBtn.setBounds(0, 0, 81, 39);
		...
		lbldescription_BA.setFont(new Font("Verdana", Font.PLAIN, 14));
		lbldescription_BA.setBounds(178, 7, 115, 25);
		panel_BA.add(lbldescription_BA);
		
		JLabel lblName_BA = new JLabel("Name: "+netManagement.getBankAccountMethod().getName());
		lblName_BA.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblName_BA.setBounds(228, 34, 135, 25);
		panel_BA.add(lblName_BA);
		
		JLabel lblCardNumber_BA = new JLabel("STK: "+netManagement.getBankAccountMethod().getCardNumber());
		lblCardNumber_BA.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblCardNumber_BA.setBounds(228, 55, 135, 25);
		panel_BA.add(lblCardNumber_BA);
		...
		lbldescription_Momo.setFont(new Font("Verdana", Font.PLAIN, 14));
		lbldescription_Momo.setBounds(96, 7, 115, 25);
		panel_momo.add(lbldescription_Momo);
		
		JLabel lblName_Momo = new JLabel("Name: "+netManagement.getMomoMethod().getName());
		lblName_Momo.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblName_Momo.setBounds(228, 34, 188, 25);
		panel_momo.add(lblName_Momo);
		
		JLabel lblPhoneNumber = new JLabel("PhoneNumber: "+netManagement.getMomoMethod().getPhoneNumber());
		lblPhoneNumber.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblPhoneNumber.setBounds(228, 55, 188, 25);
		panel_momo.add(lblPhoneNumber);
		...
		lbldescription_Cash.setFont(new Font("Verdana", Font.PLAIN, 14));
		lbldescription_Cash.setBounds(86, 7, 115, 25);
