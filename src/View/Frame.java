...
public class Frame extends JFrame {
	...
	private void initialize() {
		...
		paymentFrame.getBa_RadioBtn().addItemListener(paymentController);
		paymentFrame.getMomo_RadioBtn().addItemListener(paymentController);
		paymentFrame.getCash_RadioBtn().addItemListener(paymentController);
